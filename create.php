...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(!empty($name) && !empty($lastName) && !empty($age) && !empty($symptoms)){
        ...
        //$_SESSION['success_store'] = "Paciente registrado exitosamente!!";
        // Redirigir a home.php
        header('Location: home.php?response_alert=1');
        exit;
    }else{
        $showAlert = true;
    }
...
<div class="">
        ...
        <section class="w-full mt-10 rounded-xl bg-white shadow-xl px-5 md:px-10 py-10">
            <?php if($showAlert): ?>
